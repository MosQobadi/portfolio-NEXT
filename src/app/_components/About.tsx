          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8" data-aos="fade-right">
                ...
                with a strong emphasis on crafting seamless user interfaces and
                scalable application logic. Dedicated to continuous learning and
                contributing to innovative projects that address real-world
